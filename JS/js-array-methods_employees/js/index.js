...
function findByCitySubString(employees, string) {
  return employees.find((employee)=>{return employee.city.includes(string)})
}
...
function findByProfessionSubStringAndAge(employees, string, age) {
  return employees.find((employee)=>{return employee.profession.includes(string) && employee.age > Number(age) });
}
