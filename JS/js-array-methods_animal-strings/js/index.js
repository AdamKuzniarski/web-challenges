...
const hippoIndex = animalStrings.indexOf("hippo");
console.log(hippoExists, hippoIndex);
...
const indexOfGiraffe = animalStrings.indexOf("GirafFe".toLowerCase());
...
const sumOfAllAnimalCharacters = animalStrings.reduce((acc, currentValue) => {
