...
copyInUppercaseButton.addEventListener("click", () => {
  const temp = firstCopyInUppercaseInput.value.toUpperCase();
  secondCopyInUppercaseInput.value = temp;
});
// --^-- End of Task 2 --^--
...
switchValueButton.addEventListener("click", () => {
  const temp2 = firstSwitchValueInput.value;
  firstSwitchValueInput.value = secondSwitchValueInput.value;
  secondSwitchValueInput.value = temp2;
});
